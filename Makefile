...
DEPS=defs.hpp graphmodel.hpp h_random.hpp ioroutines.hpp mcsim.hpp mkmodel.hpp optimizer.hpp stat_tester.hpp hidden_cascade.hpp
VACOBJ=hidden_cascade.o vaccinator.o h_random.o graphmodel.o ioroutines.o defs.o
